package sessions;
import java.util.*;
public class SmartPhTempApp {
	public static void main(String[] args) {	// Store room temperature(sensor gives double)
		ArrayList<Double>temperature = new ArrayList();  //Autoboxing: double->Double
		temperature.add(26.8);
		temperature.add(30.2);
		temperature.add(22.8);
		temperature.add(29.8);// Analyzer temperatures(Unboxing)
